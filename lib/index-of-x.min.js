 ...
 * @module index-of-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),isString=_dereq_("is-string"),toObject=_dereq_("to-object-x"),toLength=_dereq_("to-length-x"),sameValueZero=_dereq_("same-value-zero-x"),safeToString=_dereq_("safe-to-string-x"),sameValue=_dereq_("object-is"),findIndex=_dereq_("find-index-x"),calcFromIndex=_dereq_("calculate-from-index-x"),splitString=!1===_dereq_("has-boxed-string-x"),pIndexOf=Array.prototype.indexOf;"function"==typeof pIndexOf&&-1===[0,1].indexOf(1,2)||(pIndexOf=function indexOf(searchElement){var length=toLength(this.length);if(length<1)return-1;var i=arguments[1];for(i=i>=0?i:Math.max(0,length+i);i<length;){if(i in this&&this[i]===searchElement)return i;i+=1}return-1});var findIdxFrom=function findIndexFrom(array,searchElement,fromIndex,extendFn){for(var fIdx=fromIndex,length=toLength(array.length);fIdx<length;){if(fIdx in array&&extendFn(array[fIdx],searchElement))return fIdx;fIdx+=1}return-1};module.exports=function indexOf(array,searchElement){var object=toObject(array),iterable=splitString&&isString(object)?object.split(""):object;if(toLength(iterable.length)<1)return-1;var extend,args=[searchElement];arguments.length>2&&(arguments.length>3?(args[1]=arguments[2],extend=arguments[3]):isString(arguments[2])&&(extend=safeToString(arguments[2])));var extendFn;if(isString(extend)&&("samevalue"===(extend=extend.toLowerCase())?extendFn=sameValue:"samevaluezero"===extend&&(extendFn=sameValueZero)),extendFn&&(0===searchElement||$isNaN(searchElement))){var fromIndex=calcFromIndex(iterable,arguments[2]);return fromIndex>0?findIdxFrom(iterable,searchElement,fromIndex,extendFn):findIndex(iterable,function(element,index){return index in iterable&&extendFn(searchElement,element)})}return!1===Boolean(extendFn)&&1===args.length&&arguments.length>2&&(args[1]=calcFromIndex(iterable,arguments[2])),pIndexOf.apply(iterable,args)}},{"calculate-from-index-x":3,"find-index-x":5,"has-boxed-string-x":7,"is-nan":14,"is-string":19,"object-is":26,"safe-to-string-x":31,"same-value-zero-x":32,"to-length-x":34,"to-object-x":35}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":12,"is-primitive":18,"safe-to-string-x":31}],3:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x"),isFunction=_dereq_("is-function-x"),isLength=_dereq_("lodash.islength");module.exports=function isArrayLike(value){return!1===isNil(value)&&!1===isFunction(value,!0)&&isLength(value.length)}},{"is-function-x":12,"is-nil-x":17,"lodash.islength":21}],11:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":17}],31:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":8,"is-symbol":20}],32:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var is=_dereq_("object-is");module.exports=function sameValueZero(x,y){return x===y||is(x,y)}},{"object-is":26}],33:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),$isFinite=_dereq_("is-finite-x"),$sign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=Number(value);return $isNaN(number)?0:0===number||!1===$isFinite(number)?number:$sign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":11,"is-nan":14,"math-sign-x":23}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var $requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function ToObject(value){return Object($requireObjectCoercible(value))}},{"require-object-coercible-x":30}],36:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":22,"validate.io-undefined":41}],37:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":20}],38:[function(_dereq_,module,exports){/**
